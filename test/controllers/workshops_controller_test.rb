...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'redirects to workshop when requesting README.md' do
  ...
  test 'renders markdown files from workshops' do
    get '/soccer/initial_setup.md'

    assert_select '.workshop-contents > h1', 'Step 1: Understanding the Initial Setup'
  end

  test 'title with markdown files in workshops' do
    get '/soccer/initial_setup.md'

    assert_select 'title', 'initial_setup.md | Hack Club Workshops'
  end
